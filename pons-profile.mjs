...
async function load() {
  ...
  for await (const line of rl) {
    ...
    rows.push({
      ...
      snipers: Number(r.snipersN ?? (Array.isArray(r.snipers) ? r.snipers.length : 0)), snipeTaxQ: hu(r.snipeTaxTotal),
      snipeExempt: Math.max(Array.isArray(r.snipeExemptions) ? r.snipeExemptions.length : 0, Number(r.snipeExemptCount) || 0),
